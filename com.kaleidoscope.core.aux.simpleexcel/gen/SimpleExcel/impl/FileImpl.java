 ...
 * @generated
 */
public class FileImpl extends ExcelElementImpl implements File {
	/**
	...
	protected EClass eStaticClass() {
		return SimpleExcelPackage.Literals.FILE;
	}
	...
	public EList<Sheet> getSheet() {
		if (sheet == null) {
			sheet = new EObjectContainmentEList<Sheet>(Sheet.class, this, SimpleExcelPackage.FILE__SHEET);
		}
		return sheet;
	}
	...
	public void setFileName(String newFileName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SimpleExcelPackage.FILE__FILE_NAME, oldFileName,
					fileName));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case SimpleExcelPackage.FILE__SHEET:
