...
public interface SimpleTreePackage extends EPackage {
	 ...
	 * @generated
	 */
	String eNS_URI = "platform:/plugin/SimpleTree/model/SimpleTree.ecore";
	 ...
	 * @ordered
	 */
	int NODE__CHILDREN = TEXT_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int NODE__ATTRIBUTE = TEXT_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int NODE__START_INDEX = TEXT_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int NODE__START_LINE_INDEX = TEXT_FEATURE_COUNT + 3;
	 ...
	 * @ordered
	 */
	int NODE__STOP_INDEX = TEXT_FEATURE_COUNT + 4;
	 ...
	 * @ordered
	 */
	int NODE__STOP_LINE_INDEX = TEXT_FEATURE_COUNT + 5;
	 ...
	 * @ordered
	 */
	int NODE_FEATURE_COUNT = TEXT_FEATURE_COUNT + 6;
