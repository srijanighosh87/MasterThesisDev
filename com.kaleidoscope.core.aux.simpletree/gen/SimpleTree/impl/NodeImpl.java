 ...
 * </p>
 * <ul>
 *   <li>{@link SimpleTree.impl.NodeImpl#getFile <em>File</em>}</li>
...
public class NodeImpl extends TextImpl implements Node {
	 ...
	 */
	public File getFile() {
		if (eContainerFeatureID() != SimpletreePackage.NODE__FILE)
			return null;
	...
	public NotificationChain basicSetFile(File newFile, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject) newFile, SimpletreePackage.NODE__FILE, msgs);
		return msgs;
	}
	...
	public void setFile(File newFile) {
		if (newFile != eInternalContainer()
				|| (eContainerFeatureID() != SimpletreePackage.NODE__FILE && newFile != null)) {
			...
			if (newFile != null)
				msgs = ((InternalEObject) newFile).eInverseAdd(this, SimpletreePackage.FILE__ROOT_NODE, File.class,
						msgs);
			msgs = basicSetFile(newFile, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SimpletreePackage.NODE__FILE, newFile, newFile));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case SimpletreePackage.NODE__FILE:
			if (eInternalContainer() != null)
				msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		...
		case SimpletreePackage.NODE__FILE:
			return eInternalContainer().eInverseRemove(this, SimpletreePackage.FILE__ROOT_NODE, File.class, msgs);
		}
